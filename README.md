...
- **[Stage 1 vs Stage 2 Cooling Diagnostics](guides/stage-1-vs-stage-2-cooling-diagnostics.md)** — The most-misdiagnosed AC issue in South Florida: a two-stage compressor running continuously on low stage during summer peak heat is often correct operation, not a malfunction. Covers the temperature-gap staging decision table, four field methods for identifying which stage is active (delta T measurement, sound/airflow, thermostat display, compressor-start listening), wiring and control failures that prevent stage escalation, the normal runtime profile of a properly operating two-stage system on a 95°F afternoon, and when "it runs all day" actually means you need [professional AC repair](https://ac-repair.today/services/ac-repair/).
...
- **[Condenser Fan Blade & Fan Guard Damage](guides/condenser-fan-blade-damage.md)** — A damaged fan blade or bent fan guard restricts condenser airflow and mimics the symptoms of a refrigerant leak or bad capacitor. Covers visual inspection (cracked blades, warped blades, UV-embrittled plastic), South Florida causes (hurricane debris, hail, landscaping impact), the diagnostic tests (visual spin test, airflow check, vibration test), blade vs guard vs motor replacement guidance, and preventive measures for coastal environments. Essential reading after any storm or physical impact near the outdoor unit.
